...
export class TimerService {
  ...
  public sleeping: any[] = [];
  public fecesDone: any[] = [];
  public urineDone: any[] = [];
  ...
  setTimerObjects(): void {
    const size = this.childrenService.children.length;

    for (const key in this.childrenService.children) {
  ...
  runBreastFeeding(index: number): void {
    let stopTime = null;
    let startTime = null;
    let sumTime = null;
  ...
  clearBreastFeeding(index: number): void {
    clearInterval(this.breastFeedingInterval[index]);
  ...
  runBottleFeeding(index: number): void {
    let stopTime = null;
    let startTime = null;
    let sumTime = null;
  ...
  clearBottleFeeding(index: number): void {
    clearInterval(this.bottleFeedingInterval[index]);
  ...
  clearSleeping(index: number): void {
    clearInterval(this.sleepingInterval[index]);
  ...
  miliSecondConvert(date: any): any {
  ...
  secondConvertToMinutes(date: any): number {
